    ...
    <footer className="w-full bg-gradient-to-r from-purple-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 border-t border-purple-100 dark:border-slate-700">
      <div className="container px-4 md:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-purple-800 dark:text-purple-200">Quick Links</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-purple-800 dark:text-purple-200">Support</h3>
            <ul className="space-y-2">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-purple-800 dark:text-purple-200">Connect</h3>
